...
import { REGEXP_CODE_SIX, REGEXP_EMAIL, REGEXP_PHONE, REGEXP_PWD, REGEXP_USERNAME } from '@/config';
...
export const formRules: CustomFormRules = {
  userName: [
    ...
    { pattern: REGEXP_USERNAME, message: '用户名格式错误', trigger: 'input' }
  ],
  phone: [
  ...
  pwd: [
    ...
    { pattern: REGEXP_PWD, message: '密码为8-16位数字/字符/符号，至少2种组合', trigger: 'input' }
  ],
  code: [
