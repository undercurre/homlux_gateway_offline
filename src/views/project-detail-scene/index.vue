<template>
  <n-grid class="w-full h-full bg-#fff" cols="5" responsive="screen" :x-gap="16" :y-gap="16">
    ...
    >
      ...
      <auto-list v-if="activeKey === 'auto'" :project-id="projectStore.curId"></auto-list>
      <yijian-list
      ...
      ></yijian-list>
      <schedule-list v-if="activeKey === 'schedule'" :project-id="projectStore.curId"></schedule-list>
    </n-grid-item>
...
import YijianList from '@/views/project-manager/components/detail/components/yijian.vue';
import ScheduleList from '@/views/project-manager/components/detail/components/schedule.vue';
import AutoList from '@/views/project-manager/components/detail/components/auto.vue';
